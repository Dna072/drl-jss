...
if __name__ == "__main__":
    ...
    agent.load(
        file_path_name=f"files/trainedAgents/dqn_seco_{N_MACHINES}m_{N_RECIPES}r_{JOBS_BUFFER_SIZE}b_{GAMMA}g_ma_obs_pure_x2_"
    ...
    agent.save(
        file_path_name=f"files/trainedAgents/dqn_seco_{N_MACHINES}m_{N_RECIPES}r_{JOBS_BUFFER_SIZE}b_{GAMMA}g_ma_obs_pure_x3_"
        + str(LEARNING_MAX_STEPS)
    )
