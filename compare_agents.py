...
DQN_AGENT_PATH = "files/trainedAgents/dqn_seco_2m_2r_3b_0.9g_real_45100000"
PPO_AGENT_PATH = "files/trainedAgents/ppo_agent_multi_recipe_job_8100000"
A2C_AGENT_PATH = "files/trainedAgents/a2c_seco_recipes_2m_2r_3b_real_20100000"
...
HEURISTIC_PATH = SAVE_PATH + f"heuristic_data_seco_{N_MACHINES}m_{N_RECIPES}r_{JOBS_BUFFER_SIZE}b_seco_recipes_obs" + str(N_EPISODES) + ".pkl"
...
EDD_PATH= SAVE_PATH + f"edd_data_seco_{N_MACHINES}m_{N_RECIPES}r_{JOBS_BUFFER_SIZE}b_seco_recipes_obs" + str(N_EPISODES) + ".pkl"
...
FIFO_PATH = SAVE_PATH + f"fifo_data_seco_{N_MACHINES}m_{N_RECIPES}r_{JOBS_BUFFER_SIZE}b_seco_recipes_obs" + str(N_EPISODES) + ".pkl"
...
DQN_PATH = SAVE_PATH + f"dqn_data_seco_{N_MACHINES}m_{N_RECIPES}r_{JOBS_BUFFER_SIZE}b_0.9g_seco_recipes_obs_10_min" + str(N_EPISODES) + ".pkl"
...
A2C_PATH = SAVE_PATH + f"a2c_data_seco_{N_MACHINES}m_{N_RECIPES}r_{JOBS_BUFFER_SIZE}b_seco_recipes_obs" + str(N_EPISODES) + ".pkl"
