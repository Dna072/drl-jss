...
DQN_AGENT_PATH = "files/trainedAgents/dqn_seco_3m_3r_0.9g_3b_norm_ops_j_que100100000"
PPO_AGENT_PATH = "files/trainedAgents/ppo_agent_multi_recipe_job_8100000"
A2C_AGENT_PATH = "files/trainedAgents/a2c_seco_recipes_3m_3r_3b_real_20100000.zip"
...
#HEURISTIC_PATH = SAVE_PATH + f"heuristic_data_seco_{N_MACHINES}m_{N_RECIPES}r_{JOBS_BUFFER_SIZE}b_seco_recipes_j_q_" + str(N_EPISODES) + ".pkl"
...
#EDD_PATH= SAVE_PATH + f"edd_data_seco_{N_MACHINES}m_{N_RECIPES}r_{JOBS_BUFFER_SIZE}b_seco_recipes_j_q_" + str(N_EPISODES) + ".pkl"
...
#FIFO_PATH = SAVE_PATH + f"fifo_data_seco_{N_MACHINES}m_{N_RECIPES}r_{JOBS_BUFFER_SIZE}b_seco_recipes_j_q_" + str(N_EPISODES) + ".pkl"
...
#DQN_PATH = SAVE_PATH + f"dqn_data_seco_{N_MACHINES}m_{N_RECIPES}r_{JOBS_BUFFER_SIZE}b_{GAMMA}g_norm_recipes_j_q_100M" + str(N_EPISODES) + ".pkl"
...
#A2C_PATH = SAVE_PATH + f"a2c_data_seco_{N_MACHINES}m_{N_RECIPES}r_{JOBS_BUFFER_SIZE}b_seco_recipes_j_q_" + str(N_EPISODES) + ".pkl"
