...
DQN_AGENT_PATH = "files/trainedAgents/dqn_seco_2m_2r_0.62g_3b_real_g12_35100000"
...
HEURISTIC_PATH = SAVE_PATH + f"heuristic_data_seco_{N_MACHINES}m_{N_RECIPES}r_{JOBS_BUFFER_SIZE}b_seco_recipes_" + str(N_EPISODES) + ".pkl"
...
EDD_PATH= SAVE_PATH + f"edd_data_seco_{N_MACHINES}m_{N_RECIPES}r_{JOBS_BUFFER_SIZE}b_seco_recipes_" + str(N_EPISODES) + ".pkl"
...
FIFO_PATH = SAVE_PATH + f"fifo_data_seco_{N_MACHINES}m_{N_RECIPES}r_{JOBS_BUFFER_SIZE}b_seco_recipes_" + str(N_EPISODES) + ".pkl"
...
DQN_PATH = SAVE_PATH + f"dqn_data_seco_{N_MACHINES}m_{N_RECIPES}r_{JOBS_BUFFER_SIZE}b_0.62g_seco_recipes_updated_" + str(N_EPISODES) + ".pkl"
...
A2C_PATH = SAVE_PATH + f"a2c_data_seco_{N_MACHINES}m_{N_RECIPES}r_{JOBS_BUFFER_SIZE}b_seco_recipes_" + str(N_EPISODES) + ".pkl"
