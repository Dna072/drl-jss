...
DQN_AGENT_PATH = "files/trainedAgents/dqn_seco_3m_3r_0.9g_3b_norm_ops_j_que40100000"
...
HEURISTIC_PATH = 'files/data/heuristic_data_seco_2_machines_1000.pkl'
...
EDD_PATH = 'files/data/edd_data_seco_2m_2r_3b_1000.pkl'
...
FIFO_PATH = 'files/data/fifo_data_seco_2m_2r_3b_1000.pkl'
...
#DQN_PATH = SAVE_PATH + f"dqn_data_seco_{N_MACHINES}m_{N_RECIPES}r_{JOBS_BUFFER_SIZE}b_{GAMMA}g_norm_recipes_j_q_" + str(N_EPISODES) + ".pkl"
DQN_PATH = 'files/data/dqn_data_seco_2m_2r_3b_0.6g_1000.pkl'
...
A2C_PATH = 'files/data/a2c_data_seco_2m_2r_tray_caps_obs_1000.pkl'
