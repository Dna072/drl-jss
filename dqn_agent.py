    ...
    def __init__(self, custom_env: FactoryEnv | Monitor) -> None:
        ...
        self.model: DQN = DQN(
            policy=self.POLICY, env=self.custom_env, verbose=self.IS_VERBOSE,
             gamma=0.9, exploration_fraction=0.5, batch_size=20_000
...
if __name__ == "__main__":
    ...
    agent.save(file_path_name="files/trainedAgents/dqn_agent_multi_recipe_job_expanded_"+str(LEARNING_MAX_STEPS))
