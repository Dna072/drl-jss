...
if __name__ == "__main__":
    ...
    agent = Agent(custom_env=init_custom_factory_env(max_steps=ENVIRONMENT_MAX_STEPS,
                                              ...
                                              n_recipes=2, job_deadline_ratio=0.3, n_machines=2),
                  gamma=GAMMA)
    ...
    agent.save(file_path_name=f"files/trainedAgents/dqn_agent_seco_{N_MACHINES}_machines_{N_RECIPES}_recipes_gamma_{GAMMA}_"+str(LEARNING_MAX_STEPS))
