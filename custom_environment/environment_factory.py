...
def create_factory_env(machines: list[Machine], jobs: list[Job], recipes: list[Recipe]) -> MyFactoryEnv:
    """
    ...
    """
    return FactoryEnv(machines=machines, jobs=jobs, recipes=recipes, max_steps=10)


def init_custom_factory_env(is_verbose: bool = False) -> MyFactoryEnv:
    """
    ...
    factory_env: FactoryEnv = create_factory_env(machines=machines, jobs=jobs, recipes=recipe_objects,)
    return factory_env
