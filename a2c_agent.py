...
if __name__ == "__main__":
    ...
    agent.save(file_path_name=f"files/trainedAgents/a2c_agent_seco_{N_MACHINES}m_{N_RECIPES}r_{JOBS_BUFFER_SIZE}b_tray_cap_obs_"+str(LEARNING_MAX_STEPS))
